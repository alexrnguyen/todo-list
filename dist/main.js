...
const triggerTaskEditModal = (task, project) => {
  ...
  document.getElementById("task-edit-due-date").value = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(
    task.dueDate,
    "yyyy-MM-dd"
  );
...
const triggerTaskModal = (project) => {
  ...
  taskForm.onsubmit = (event) => {
    ...
    const newTask = (0,_controllers_task_controller__WEBPACK_IMPORTED_MODULE_4__.addTaskItem)(name, description, dueDate, priority, project);
...
const createSidebar = () => {
  ...
  const generalItem = (0,_models_project__WEBPACK_IMPORTED_MODULE_4__["default"])(
    "General",
