...
const addTaskItem = (name, description, dueDate, priority, project) => {
  const newTask = (0,_models_task__WEBPACK_IMPORTED_MODULE_0__["default"])(name, description, dueDate, priority, false);
...
/* harmony import */ var _task_item__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./task-item */ "./src/ui/task-item.js");
...
/* harmony import */ var _controllers_task_controller__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../controllers/task-controller */ "./src/controllers/task-controller.js");
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./sidebar */ "./src/ui/sidebar.js");
...
const createProjectModal = () => {
  ...
  const closeIcon = new Image();
  closeIcon.className = "icon";
  closeIcon.src = _assets_close_svg__WEBPACK_IMPORTED_MODULE_4__;
...
const triggerTaskModal = (project) => {
  ...
  taskForm.onsubmit = (event) => {
    ...
    const newTask = (0,_controllers_task_controller__WEBPACK_IMPORTED_MODULE_5__.addTaskItem)(name, description, dueDate, priority, project);

    const taskItemsContainer = document.getElementById("task-items-container");
    const addTaskButton = document.getElementById("add-task-button");
    taskItemsContainer.insertBefore(
      (0,_task_item__WEBPACK_IMPORTED_MODULE_3__["default"])(newTask, project),
      addTaskButton
    );
    (0,_sidebar__WEBPACK_IMPORTED_MODULE_6__.updateProjectCount)(project, true);
    taskForm.reset();
    toggleModal(taskModal);
    event.preventDefault();
  };
...
/* harmony import */ var _edit_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./edit-modal */ "./src/ui/edit-modal.js");
...
const loadProject = (project) => {
  ...
  editButton.addEventListener("click", () => {
    (0,_edit_modal__WEBPACK_IMPORTED_MODULE_5__.triggerProjectEditModal)(project);
  });
...
const createTaskItem = (task, project) => {
  ...
  date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(task.dueDate, "yyyy-MM-dd");
