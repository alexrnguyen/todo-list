...
const triggerTaskModal = () => {
  ...
  taskForm.onsubmit = (event) => {
    ...
    const newTask = (0,_controllers_project_controller__WEBPACK_IMPORTED_MODULE_0__.addProjectItem)(name, description);

    const taskItemsContainer = document.getElementById("task-items-container");
    taskItemsContainer.appendChild((0,_task_item__WEBPACK_IMPORTED_MODULE_3__["default"])(newTask));
    (0,_project_content__WEBPACK_IMPORTED_MODULE_1__.loadProject)(newTask);
    taskForm.reset();
    toggleModal(taskModal);
    event.preventDefault();
  };
...
const loadProject = (project) => {
  ...
  tasks.forEach((task) => taskItemContainer.appendChild((0,_task_item__WEBPACK_IMPORTED_MODULE_2__["default"])(task)));
  ...
  addTaskButton.addEventListener("click", () => {
    (0,_modal__WEBPACK_IMPORTED_MODULE_3__.triggerTaskModal)();
  });
...
const createTaskItem = (task) => {
  ...
  date.textContent = (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(task.date, "yyyy-MM-dd");
